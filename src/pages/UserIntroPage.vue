<template>
  <div v-if="userInfo" style="text-align: center;">
    ...
    <van-cell title="id" :value="userInfo?.id" icon="user-o"/>
  ...
  <div style="text-align: center; margin-top: 10px;">
    <van-button icon="plus" type="success" text="添加好友" size="normal" style="border-radius: 10px"/>
